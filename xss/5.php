<?php
if (!isset($_COOKIE['labs-hypersec'])) {
	setcookie('labs-hypersec', 'labs-hypersec', time() + (86400 * 30), "/",null,null,true);
	header("Refresh:0");
}
session_start();
...
<head>
    ...
    <title><?php echo $hasil['title'];?> | Xss #x04</title>
            ...
            <div class="col-lg-12">
                ...
                <!-- <div class="row ">
                    <div class="col-md-6 d-flex justify-content-center" >
                        ...
                        <input type="text" class="form-control mb-3" name="file" >
                    </div>
                </div><br> -->
...
if (isset($_COOKIE['labs-hypersec'])) {
    ...
    echo "<br><span style=\"font-size:1em;\">Current value supplied by <b>labs-hypersec</b> cookie is: </span><br>" . (string)$_COOKIE['labs-hypersec'] . '';
