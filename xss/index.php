...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <h2 class="text-primary"><a href="1.php" style="text-decoration:none;">- Parameter</a></h2>
                <h2 class="text-primary"><a href="2.php" style="text-decoration:none;">- Form</a></h2>
                <h2 class="text-primary"><a href="3.php" style="text-decoration:none;">- User-Agent</a></h2>
            </div>
            <div class="col-md-6">
                <h2 class="text-primary"><a href="4.php" style="text-decoration:none;">- Refferer</a></h2>
                <h2 class="text-primary"><a href="5.php" style="text-decoration:none;">- Cookie</a></h2>
