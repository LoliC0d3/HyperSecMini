...
<head>
    ...
    <title><?php echo $hasil['title'];?> | Cors #x02</title>
...
<body>
    ...
    <div class="container">
        ...
        <?php
	header( 'Are You Ready To lose?' );

	if (isset($_SERVER['HTTP_ORIGIN']) && preg_match('#tegalsec.org#', $_SERVER['HTTP_ORIGIN']))
		{
