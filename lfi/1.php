...
<head>
    ...
    <title><?php echo $hasil['title'];?> | Command Injection #x01</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row tall-row">
            <div class="col-lg-12">
                <h1>Command Injection - Chall #x01</h1>
                <hr>
...
?>
        ...
        <div class="row">
        <div class="col-md-6">
                <h2>will include the arg specified in the POST parameter \"file\", strips prepended \"../\" strings, must encode / with %2f<</h2>
