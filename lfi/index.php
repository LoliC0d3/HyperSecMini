...
<head>
    ...
    <title><?php echo $hasil['title'];?> | LFI</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <p>LFI attack can lead to Cross-site Scripting and remote code execution (RFI for short) vulnerabilities.  </p>
        ...
        <div class="row">
            <div class="col-md-6">
                <h2 class="text-primary"><a href="1.php" style="text-decoration:none;">- Post Parameter</a></h2>
                <h2 class="text-primary"><a href="2.php" style="text-decoration:none;">- Text</a></h2>
                <h2 class="text-primary"><a href="3.php" style="text-decoration:none;">- Directory Traversal </a></h2>
            </div>
