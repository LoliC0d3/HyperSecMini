...
<body>
    ...
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <p>SQL injection is a web security vulnerability that allows an attacker
                 to interfere with the queries that an application makes to its database</p>
        ...
        <div class="row">
            <div class="col-md-6">
                <h2 class="text-primary"><a href="1.php" style="text-decoration:none;">- SQL Injection</a></h2>
