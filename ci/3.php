...
<head>
    ...
    <title><?php echo $hasil['title'];?> | Command Injection #x03</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row tall-row">
            <div class="col-lg-12">
                <h1>Command Injection - Chall #x03</h1>
                <hr>

                <div class="row ">
                    <div class="col-md-6 d-flex justify-content-center" >
                        <form action="3.php" method="GET">
                        <input type="text" class="form-control mb-3" name="domain" placeholder="google.com">
                    </div>
                </div><br>
...
<?php
 ...
 ?>
        ...
        <div class="row">
        <div class="col-md-6">
                <h2>will exec the arg specified in the GET parameter  <font color="red">cmd</font></h2>
