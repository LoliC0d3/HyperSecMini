...
<head>
    ...
    <title><?php echo $hasil['title'];?> | Brow #x02</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row tall-row">
            <div class="col-lg-12">
                <h1>Brow - Chall #x02</h1>
                <hr>

                <div class="row ">
                    <div class="col-md-6 d-flex justify-content-center" >
                        <form action="2.php" method="post">
                        <input type="text" class="form-control mb-3" name="name" value="wrong-post-data">
                    </div>
                </div><br>
...
if (isset($_POST["name"]) && !empty($_POST["name"]) && $_POST["name"] != "br0wser") {
    ...
    echo '<br><br><div  class="btn btn-info"><a href="3.php">Next Chall</a></div>';
}
?></div>
        ...
        <div class="row">
        <div class="col-md-6">
                <h2>Change name on POST data to <font color="yellow">br0wser</font></h2>
