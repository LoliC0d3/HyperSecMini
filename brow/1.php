...
<head>
    ...
    <title><?php echo $hasil['title'];?> | Brow #x01</title>
...
echo '<br><br><button class="btn btn-info"><h4><a href="2.php">Next Chall</a></h4></button>';
}else {
...
?>
        ...
        <div class="row">
        <div class="col-md-6">
                <h2>Change your user agent to <font color="yellow">br0wser</font></h2>
